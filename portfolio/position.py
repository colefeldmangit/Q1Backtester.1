# from QSTrader by mhallsmoore
from math import floor
import numpy as np

# TODO: check methods (net anything/P&L) for changes since we will be passing order/transaction side directly
class Position(object):
    ...
    def open_from_transaction(cls, transaction):
        ...
        # TODO: when we call these methods change this to take a order.SIDE
        if transaction.quantity > 0:
            ...
            buy_quantity = 0
            # TODO: potentially change this to positive
    ...
    # TODO: check if this is necessary. We will just be passing the order with a side already hooked up
    @property
    def direction(self):
        """
    ...
    def total_sold(self):
        ...
        -------
        `float`
            The total average cost of assets sold.
        """
